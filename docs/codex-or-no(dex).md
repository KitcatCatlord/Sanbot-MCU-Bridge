...
I've used Codex to compile these. This is because there are literally thousands of .smali files in the original firmware, and I don't have the time or .smali experience to go through it and write the logic myself. Instead, I got ChatGPT to find all of the logic and write it as 'pseudologic' as I call it. This meant I got accurate data from the original firmware without spending ages sorting through it manually.
...
I was initially just using a database I generated of all of the commands, and I still use that as a lookup table, but that was quite a hassle as there was lots of back and forth.
