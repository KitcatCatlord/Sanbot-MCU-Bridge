...
The project was originally written in Python as a prototype, a proof-of-concept. The Python prototype mixed hand-written code with fast experimental scaffolding while I was learning the firmware behavior.
